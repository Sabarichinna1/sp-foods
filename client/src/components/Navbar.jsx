      ...
      {/* user navbar */}
        ...
        {!usertype ?
            ...
            <div className="navbar">
              <h3 onClick={()=> navigate('')}>SB Foods Delivery</h3>
              <div className="nav-content">
                <div className="nav-search">
                  <input type="text" name="nav-search" id="nav-search" placeholder='Find Restaurants...,' onChange={(e)=>setProductSearch(e.target.value)}  />
